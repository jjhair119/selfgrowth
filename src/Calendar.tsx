...
import ConfirmButtons from "./components/ConfirmButton.tsx";
...
const Calendar: React.FC<CalendarProps> = () => {
  ...
  const weeks = Array.from(
    { length: Math.ceil(days_sample.length / 7) },
    (_, index) => (
      ...
      <CalendarWrap>
        {currentView == "CALENDAR" && (
          <CalendarView>
            ...
            <CalendarWeek>
              <DayWrap>{weeks}</DayWrap>
            </CalendarWeek>
            <ConfirmButtonWrap>
              <ConfirmButtons $bgColor={"#e6e6e6"}>cancel</ConfirmButtons>
              <ConfirmButtons
                $bgColor={"#e6e6e6"}
